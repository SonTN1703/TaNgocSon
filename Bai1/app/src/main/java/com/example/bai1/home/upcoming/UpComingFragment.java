...
import com.example.bai1.databinding.FragmentUpcomingBinding;
...
public class UpComingFragment extends Fragment implements MovieItemListener {
    ...
    public void observeViewModel() {
        homeViewModel.fetchUpcomingMovies(Constants.API_KEY, 1);
        homeViewModel.getUpcomingMutableLiveData().observe(requireActivity(), resultResponse -> {
    ...
    public void initView() {
        rcvMovies = mView.findViewById(R.id.rcv_upcoming);
    }
